...
function a1_load_questions() {}
{
	...
	question.push({
		srno: 3,
		question:
			"Select <span style='color: #018fc3'> Capacitance and temperature panel </span>",
