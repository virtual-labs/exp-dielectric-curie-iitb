...
let dielectric_obs: number[] = []
let temperature_obs: number[] = []
...
function activity4() {
	...
	pp.showtitle(
		`<p id="act4-exp-title">Dielectric constant vs Temperature Plot</p>`,
		3
	);
...
function verify_curie_temperature() {
	let inp: HTMLInputElement = <HTMLInputElement> document.getElementById('exp-value');
	let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('l-btn');
	let sp :HTMLSpanElement = <HTMLSpanElement> document.getElementById('th-value');
