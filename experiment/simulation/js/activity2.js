...
function activity2() {
    ...
    probe = new Chemistry.Custome_image(vc, new Chemistry.Point(1350, 460), 804 * 1.3, 666 * 1.3, canvas);
    scene1.add(probe);
    left_pin = new Chemistry.Custome_image(left_vc, new Chemistry.Point(883, 670), 157 * 0.5, 860 * 0.5, canvas);
    scene1.add(left_pin);
    right_pin = new Chemistry.Custome_image(right_vc, new Chemistry.Point(950, 670), 157 * 0.5, 860 * 0.5, canvas);
    scene1.add(right_pin);
    pill_img = new Chemistry.Custome_image(pill, new Chemistry.Point(975, 430), 600 * 0.2, 200 * 0.2, canvas);
    scene1.add(pill_img);
    // load_buttons();
...
function show_gm_display() {
    gm_meter_reading = new Chemistry.Geo_Text('0', new Chemistry.Point(1460, 205), canvas);
