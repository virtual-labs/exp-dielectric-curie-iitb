...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(vc, new Chemistry.Point(300, 500), 1228 * 0.4, 894 * 0.4, canvas);
    sq.name = 'Vernier scale';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(chamber2, new Chemistry.Point(900, 500), 454 * 0.4, 894 * 0.4, canvas);
    sq.name = 'Chamber';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(display_panel, new Chemistry.Point(1500, 500), 1291 * 0.4, 660 * 0.4, canvas);
    sq.name = 'Capacitance and temperature panel';
    scene.add(sq);
}
...
function a1_load_questions() { }
{
    ...
    question.push({
        srno: 1,
        question: "Select <span style='color: #018fc3'>Vernier scale</span>",
        ans: 'Vernier scale',
        hint: ['has scale', '', ''],
    });
    question.push({
    ...
    question.push({
        srno: 3,
        question: "Select <span style='color: #018fc3'> Capacitance and temperature panel </span>",
        ans: 'Capacitance and temperature panel',
        hint: ['has display', '', ''],
    });
}
